...
namespace sjf::interpolation
{
     ...
     */
    template <typename T>
    T linearInterpolate ( const T mu, const T x1, const T x2 )
    { return x1 + mu*(x2-x1); }
    //==============================================================================
    /**
     ...
     */
    template <typename T>
    T fourPointInterpolatePD ( const T mu, const T x0, const T x1, const T x2, const T x3 )
    {
     ...
     */
    template <typename T>
    T fourPointFourthOrderOptimal  ( const T mu, const T x0, const T x1, const T x2, const T x3 )
    {
     ...
     */
    template <typename T>
    T cubicInterpolateGodot ( const T mu, const T x0, const T x1, const T x2, const T x3 )
    {
     ...
     */
    template <typename T>
    T cubicInterpolateHermite ( const T mu, const T x0, const T x1, const T x2, const T x3 )
    {
        T a1,a2,a3;
     ...
     */
    template <typename T>
    T cubicInterpolateHermite2 ( const T mu, const T x0, const T x1, const T x2, const T x3 )
    {
        T diff = x1 - x2;
        T a1 = x2 - x0;
