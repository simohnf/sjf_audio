...
I have attempted to keep as much of the code necessary for my vsts within these files as possible. This means the actual source for each VST is reliant n these files (I've used #include to reference the relevant files, but the paths are based on the folder hierarchy in my computer)
